...
public class SpringMain {
	...
	public static void main(String[] args) throws IOException {
		...
		ApplicationContext factory = 
				new ClassPathXmlApplicationContext("product/spring-mybatis.xml");
		
		ProductService service = (ProductService)factory.getBean("product_service");
			
		
		//전체리스트
		java.util.List<ProductDTO> list = service.getAllProducts();
